export default {
    ...
    canvas: {
        ...
        promptPanel: { video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", editorTitle: "Edit prompt", stopGeneration: "Stop generation", generate: "Generate", stop: "Stop", resetGeneration: "Reset to the parameters used for this image" },
        references: { title: "References", select: "Select references from canvas", add: "Add as reference", remove: "Remove reference", disconnect: "Disconnect reference", empty: "No content", selecting: "Adding references", choose: "Select", selectingHint: "Select references on the canvas or in the element list · ESC to return" },
        ...
        shortcut: {
            ...
            focusSelected: "Center on the selected node",
            focusBack: "Focus history: back",
            focusForward: "Focus history: forward",
    ...
    config: {
        ...
        providerLockedHint: "Filled in by the provider preset and locked",
        protocol: "Protocol",
