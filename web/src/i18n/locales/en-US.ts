export default {
    ...
    canvas: {
        ...
        references: { title: "References", select: "Select references from canvas", add: "Add as reference", remove: "Remove reference", disconnect: "Disconnect reference", empty: "No content", selecting: "Adding references", choose: "Select", selectingHint: "Select references from canvas · ESC to return" },
