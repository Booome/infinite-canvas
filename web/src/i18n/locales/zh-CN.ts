export default {
    ...
    canvas: {
        ...
        promptPanel: { video: "描述要生成的视频内容", audio: "描述要生成的音频内容", image: "描述要生成的图片内容", text: "请输入你想要生成的文本内容", editImage: "请输入你想要把这张图修改成什么", editText: "请输入你想要将本段文本修改成什么", expandEditor: "放大编辑", editorTitle: "编辑提示词", stopGeneration: "停止生成", generate: "生成", stop: "停止", resetGeneration: "重置为生成该图时的参数" },
        references: { title: "参考内容", select: "从画布选择参考节点", add: "添加为参考", remove: "取消参考", disconnect: "断开参考连接", empty: "暂无内容", selecting: "正在添加参考", choose: "选择", selectingHint: "在画布或左侧元素列表中选择参考 · ESC 返回输入框" },
    ...
    config: {
        ...
        providerLockedHint: "由服务商预设填充，不可修改",
        protocol: "协议",
            baseUrl: "接口地址",
            models: "渠道模型",
