...
export function UserStatusActions({ showConfig = true, variant = "default", onOpenShortcuts, onOpenPlugins }: UserStatusActionsProps) {
    ...
    return (
        <div className="inline-flex shrink-0 items-center gap-1">
            ...
            {showConfig ? (
                <ThemedTooltip title={t("navigation.config")}>
            ...
            <ThemedTooltip title={t(theme === "dark" ? "topNav.lightTheme" : "topNav.darkTheme")}>
                <AnimatedThemeToggler theme={theme} onThemeChange={setTheme} className={naturalIconClass} style={iconStyle} aria-label={t(theme === "dark" ? "topNav.lightTheme" : "topNav.darkTheme")} />
            </ThemedTooltip>
            <VersionReleaseModal style={versionStyle} />
            <GitHubLink className={cn("bg-transparent hover:bg-transparent dark:hover:bg-transparent", gitHubClassName)} style={gitHubStyle} />
            {onOpenShortcuts ? (
                <ThemedTooltip title={t("topNav.shortcuts")}>
